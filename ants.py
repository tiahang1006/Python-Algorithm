...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        """
        if rANTdom_else_none(position.bees):
            return rANTdom_else_none(position.bees)
        while rANTdom_else_none(position.bees) == None:
            position = position.entrance
            distance += 1
            if position != beehive and rANTdom_else_none(position.bees) and self.min_range <= distance and distance <= self.max_range:
                    return rANTdom_else_none(position.bees)
        """
        while position != beehive:
            ...
            position = position.entrance
            distance += 1
        #return rANTdom_else_snone(self.place.bees) # REPLACE THIS LINE
        # END Problem 3 and 4
